...
export class Car {
  ...
  update(deltatime: number) {
    ...
    if (this.x + this.w < this.game.obstacle.x) this.left = true;
    ...
    if (this.playerNo == 1) {
      ...
      if (input.indexOf("d") != -1) this.angle += 0.0004 * deltatime;
      if (input.indexOf("a") != -1) this.angle -= 0.0004 * deltatime;
      if (input.indexOf("w") != -1) this.speed += 0.001 * deltatime;
      if (input.indexOf("s") != -1) this.speed -= 0.001 * deltatime;
    }
  }
